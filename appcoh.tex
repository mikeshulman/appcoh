...
\Amelia{we need to talk about definition formatting. I often make vocab being defined bold or italic. what do others want to do.}
\begin{definition}
	For a type $\X$ (\Amelia{should I be using this type font X here? I'm not totally sure what it's for}) and $n:N$, the $n$-th cohomology group of $\X$ is the type
