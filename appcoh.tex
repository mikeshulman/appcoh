...
\begin{proposition}
	...
	\end{array}\right.\]
\end{proposition}
\Amelia{Finster and Licata constructed $K(G,1)$ in a particular way. Not sure how that impacts which results transfer over}

\begin{proposition}\cite{fl:em}\\
	\Amelia{(This is really an EM space)}
\end{proposition}
