...
\Chandrika{The tautological bundle over $\set{RP}^n$ is called $T^n$ for now in the text below. This is definitely a bad choice because it can be confused for a tangent space of a torus. I just couldn't think of a good choice in the moment, but I wanted to write. I do not understand the notation Egbert uses for these spaces (otherwise, I would have done something analogous)}
